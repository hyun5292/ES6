...
/*
Destructuring assignment(구조 분해 할당?) is special syntax introduced in ES6, for
neatly(깔끔하게) assigning values taken directly from an object.
...
still assign the variables today and tomorrow the values of today and tomorrow
...
/*
You may read it as "get the value of user.name and assign it to a new variables
...
/*
Replace the two assignments with an equivalent destructuring assignment. It should
still assign the variables highToday and highTomorrow the values of today and
...
/*
Replace the two assignments with an equivalent destructuring assignment. It should
still assign the variables lowToday and highToday the values of today.low and
...
because of the rest parameter's presence, arr gets the rest of the values in the
form of an array. The rest element only works correctly as the last variable in
the list. As in, you cannot use the rest parameter to catch a subarray that leaves
...
*/
/*
This effectively destructures the object sent into the function. This can also be
done in-place:
*/
